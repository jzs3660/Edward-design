...
const outPath=path.join(root,'assets/previews/aident-ppt-system.png');
await fs.mkdir(path.dirname(outPath),{recursive:true});
const size=await renderSystemPreview({canvasModule,root,tokens,components,fontManifest,iconManifest,backgroundManifest,outPath});
console.log(`aident-ppt-system.png: ${size.width}×${size.height} · direct bundled-font canvas renderer`);
